...
if (process.env.NODE_ENV === 'production') {
  ...
  const corsOptions = {
    origin: ['http://192.168.0.100:8080/', 'http://127.0.0.1:8080', 'http://localhost:8080', 'http://127.0.0.1:3030', 'http://localhost:3030', 'http://localhost:8081'],
    credentials: true
  };
...
const mixRoutes = require('./api/location/location.routes')
